...
def test(args):
    ...
    # flops, params = profile(model.net_G, (input,input,input,input,input))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_root', default='checkpointsbest', type=str)
    ...
    trainno_set = CDDataset(root_dir="/home/hdda/liangyizhou/testnet/LEVIR", split="train",
