...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', default='SYSU-CD_SEIFNet_ce_Adamw_0.0001_200', type=str)
    ...
    parser.add_argument('--data_name', default='SYSU-CD', type=str,help='ChangeDetection|LEVIR|DSFIN|SYSU-CD|LEVIR+|BBCD|WHU-CD')
    ...
    trainno_set = CDDataset(root_dir="/home/hdda/liangyizhou/mySEIFNetcopy/SYSU", split="train",
